  ...
  try {
    ...
    if (foodtruck) {
      ...
      await supabaseAdmin
        ...
        .delete()
        .in('offer_id',
          supabaseAdmin.from('offers').select('id').eq('foodtruck_id', foodtruckId)
        );
      ...
      await supabaseAdmin
        ...
        .delete()
        .in('deal_id',
          supabaseAdmin.from('deals').select('id').eq('foodtruck_id', foodtruckId)
        );
      ...
      await supabaseAdmin
        ...
        .delete()
        .in('order_item_id',
          supabaseAdmin.from('order_items').select('id').in('order_id',
      ...
      await supabaseAdmin
        ...
        .delete()
        .in('category_option_group_id',
          supabaseAdmin.from('category_option_groups').select('id').in('category_id',
      ...
      const { data: menuFiles } = await supabaseAdmin.storage
        .from('menu-images')
        .list(user.id);
