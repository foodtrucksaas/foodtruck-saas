...
const ALLOWED_ORIGINS = (
  ...
  'http://localhost:5173,http://localhost:5174,https://foodtruck-saas-client.vercel.app,https://foodtruck-saas-dashboard.vercel.app,https://client.montruck.fr,https://dashboard.montruck.fr,https://onmange.app,https://dashboard.onmange.app'
).split(',');
...
export function getCorsHeaders(origin: string | null): Record<string, string> {
  // Check if origin is allowed (exact match or valid subdomain pattern)
