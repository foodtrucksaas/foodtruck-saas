          ...
          <div className="relative">
            ...
            >
              ...
              <span className="sm:hidden">
                {DATE_PRESETS.find((p) => p.key === preset)?.label.split(' ')[0]}
              </span>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="card p-5">
          ...
          <div className="flex items-center gap-1 mt-2 text-sm text-gray-500">
            <span>{analytics?.returningCustomers || 0} clients fidèles</span>
          </div>
        </div>
      </div>
              ...
              {analytics.amountByLocation.slice(0, 5).map((loc, idx) => (
                <div key={idx} className="flex items-center justify-between">
                  ...
                  <div className="text-right ml-2">
                    <p className="text-sm font-semibold">{formatPrice(safeNumber(loc.amount))}</p>
                    <p className="text-xs text-gray-400">{loc.orderCount} cmd</p>
                  </div>
                </div>
              ))}
            </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm font-semibold text-gray-900 ml-2">
                        {formatPrice(safeNumber(item.amount))}
                      </span>
                    </div>
